...
const ENDPOINTS = {
    qa_service: {
        ...
        qa_check_metadata: {
            endpoint: `${PREFIX}${VERSION}${ENDPOINT}check-metadata`, // Deprecate
        ...
        qa_check_collection: {
            endpoint: `${PREFIX}${VERSION}${ENDPOINT}check-collection`, // Deprecate
            description: '',
            get: {
                description: '',
                params: 'api_key'
        ...
        qa_move_to_ingest: {
            endpoint: `${PREFIX}${VERSION}${ENDPOINT}move-to-ingest`, // Deprecate
            description: '',
            get: {
        ...
        qa_move_to_sftp: {
            endpoint: `${PREFIX}${VERSION}${ENDPOINT}move-to-sftp`, // Deprecate
            description: '',
            get: {
