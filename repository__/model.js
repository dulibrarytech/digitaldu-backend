...
const UPDATE_THUMBNAIL_URL_TASKS = require('.//tasks/update_thumbnail_url_tasks');
const PUBLISH_COLLECTION_RECORD_TASKS = require('.//tasks/publish_collection_record_tasks');
const PUBLISH_CHILD_RECORD_TASKS = require('.//tasks/publish_child_record_tasks');
const SUPPRESS_COLLECTION_RECORD_TASKS = require('.//tasks/suppress_collection_record_tasks');
const SUPPRESS_CHILD_RECORD_TASKS = require('.//tasks/suppress_child_record_tasks');
const INDEX_RECORD_TASKS = require('.//tasks/index_record_tasks');
const DELETE_RECORD_TASKS = require('.//tasks/delete_record_tasks');
