...
const ArchivesSpace_lib = class {
    ...
    constructor(ARCHIVESSPACE_HOST, ARCHIVESSPACE_USER, ARCHIVESSPACE_PASSWORD, ARCHIVESSPACE_REPOSITORY_ID) {
        this.ARCHIVESSPACE_HOST = ARCHIVESSPACE_HOST;
        this.ARCHIVESSPACE_USER = ARCHIVESSPACE_USER;
        this.ARCHIVESSPACE_PASSWORD = ARCHIVESSPACE_PASSWORD;
        this.ARCHIVESSPACE_REPOSITORY_ID = ARCHIVESSPACE_REPOSITORY_ID;
    }
