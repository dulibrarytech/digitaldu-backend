...
module.exports = {
    ...
    archivematicaDashboardLogin: process.env.ARCHIVEMATICA_DASHBOARD_LOGIN,
    archivematicaDashboardAip: process.env.ARCHIVEMATICA_DASHBOARD_AIP,
    archivematicaDashboardLogout: process.env.ARCHIVEMATICA_DASHBOARD_LOGOUT,
    archivematicaDashboardUsername: process.env.ARCHIVEMATICA_DASHBOARD_USERNAME,
    archivematicaDashboardPassword: process.env.ARCHIVEMATICA_DASHBOARD_PASSWORD,
    ...
    archivematicaStorageDashboardLogin: process.env.ARCHIVEMATICA_STORAGE_DASHBOARD_LOGIN,
    archivematicaStorageDashboardUsername: process.env.ARCHIVEMATICA_STORAGE_DASHBOARD_USERNAME,
    archivematicaStorageDashboardPassword: process.env.ARCHIVEMATICA_STORAGE_DASHBOARD_PASSWORD,
    archivematicaStorageDashboardPackages: process.env.ARCHIVEMATICA_STORAGE_DASHBOARD_PACKAGES,
    archivematicaStorageDashboardLogout: process.env.ARCHIVEMATICA_STORAGE_DASHBOARD_LOGOUT,
